...
# 박스 크기 정의
main_box = Rect(0, 0, 820, 240)         # (0, 0)은 왼쪽위의 좌표, (820, 240)은 오른쪽아래의 좌표를 나타냄
...
q5 = ["Where are the pyramids?", "India", "Egypt", "Morocco", "Cananda", 2]

questions = [q1, q2, q3, q4, q5]
question = questions.pop(0)         # pop은 ()안에 인덱스 번호의 값을 삭제한다.
